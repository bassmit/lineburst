...
namespace LineBurst
{
    public static partial class Draw
    {
        ...
        public static void Text(FixedString32Bytes text, float4x4 transform, Color color) => Unmanaged.Instance.Data.Font.Value.Draw(text, transform, color);
        public static void Text(FixedString64Bytes text, float4x4 transform, Color color) => Unmanaged.Instance.Data.Font.Value.Draw(text, transform, color);
        public static void Text(FixedString128Bytes text, float4x4 transform, Color color) => Unmanaged.Instance.Data.Font.Value.Draw(text, transform, color);
        public static void Text(FixedString512Bytes text, float4x4 transform, Color color) => Unmanaged.Instance.Data.Font.Value.Draw(text, transform, color);
        public static void Text(FixedString4096Bytes text, float4x4 transform, Color color) => Unmanaged.Instance.Data.Font.Value.Draw(text, transform, color);
